...
export const CATEGORY_DEFS = {
  ...
  eol: {
    key: "eol",
    title: "Списанные авто",
    subtitle: "Старые автомобили с большим пробегом и доноры. End of Life. Идеально подходят для разбора или восстановления опытными мастерами.",
    icon: "♻️",
  ...
  motorcycles: {
    key: "motorcycles",
    title: "Мотоциклы",
    subtitle: "Мотоциклы, скутеры, квадроциклы из Turners и Manheim NZ/AU. С пробегом и почти новые.",
    icon: "🏍️",
    apiFilters: { body_type: "motorcycle" },
    tips: [
      "Гарантия пробега через NZTA-историю VIN.",
      "Логистика мотоцикла в Россию дешевле, чем легкового авто.",
      "Для японских мотоциклов (Honda, Yamaha) — широкий выбор запчастей в РФ.",
    ],
  },
  trucks: {
    key: "trucks",
    title: "Грузовики",
    subtitle: "Лёгкие и средние коммерческие грузовики. Hino, Isuzu, Mitsubishi Canter, Fuso — наследие японского коммерческого экспорта.",
    icon: "🚛",
    apiFilters: { body_type: "truck" },
    tips: [
      "NZ-грузовики часто с ограниченным пробегом и сервисной книжкой.",
      "Габариты учитываются при морской доставке — проверьте размер контейнера.",
      "Срок ПТС для коммерческих ТС в РФ требует особой подготовки документов.",
    ],
  },
  machinery: {
    key: "machinery",
    title: "Спецтехника",
    subtitle: "Экскаваторы, погрузчики, тракторы, краны. Перевозка negotiable, чаще ro-ro.",
    icon: "🚜",
    apiFilters: { body_type: "machinery" },
    tips: [
      "Для тяжёлой техники доставка ro-ro обычно выгоднее контейнерной.",
      "Часть лотов поставляется без рабочего навеса — уточняйте у менеджера.",
      "Растаможка спецтехники в РФ — отдельная процедура, готовим документы заранее.",
    ],
  },
};
