...
const STEPS = [
  ...
  ["Депозит ≈ 43 600 ₽", "Депозит подтверждает серьёзность намерений и открывает доступ к торгам. Возвращается, если не выкупили (фиксированная сумма NZ$1 000 пересчитывается по курсу Google+3%)."],
